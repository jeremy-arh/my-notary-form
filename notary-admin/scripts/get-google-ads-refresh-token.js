/**
 * Script pour obtenir le Refresh Token Google Ads
 * 
 * Usage:
 * 1. Installez les dépendances: npm install googleapis
 * 2. Remplacez CLIENT_ID et CLIENT_SECRET ci-dessous
 * 3. Exécutez: node scripts/get-google-ads-refresh-token.js
 */
